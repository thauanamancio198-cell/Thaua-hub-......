...
local Window = bearlib:MakeWindow({
    ...
    SubTitle = "by Thauan",
    SaveFolder = true,
    Image = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663504212895/fWsxRjqVIwXIqaqt.jpeg"
})
...
v0:AddProfile({
    Name = "Thauan ☑",             
    Bio = "Brasil 🇧🇷", 
    Avatar = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663504212895/fWsxRjqVIwXIqaqt.jpeg", 
    Cover = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663504212895/fWsxRjqVIwXIqaqt.jpeg", 
    Verified = true 
})
-- Removido SingleDiscordCard
...
-- Removido Discord Invite Container
